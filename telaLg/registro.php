			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter username">
						<input class="input100" type="text" name="nomeCompletoTxt" placeholder="Nome completo" id="nomeCompletoTxt">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter username">
						<input class="input100" type="text" name="EmailTxt" placeholder="Email" id="emailTxt">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter username">
						<input class="input100" type="text" name="confirmarEmailTxt" placeholder="Confirmar Email" id="confirmarEmailTxt">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="confirmarSenhaTxt" placeholder="Confirmar Senha" id="confirmarSenhaTxt">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>

					<div class="container-login100-form-btn">
						<a href="index.php"><button class="login100-form-btn" id="confirmarBtn" type="button">
								Registrar
							</button></a>
					</div>
				</form>
	...
	async function cadastrarDados(e) {
		...
		if (response.status === 1) {
			Swal.fire('Atenção!', 'dados cadastrados com sucesso', 'success')
				.then(res => window.location.href = '../telaLG/index.php');
		} else {
